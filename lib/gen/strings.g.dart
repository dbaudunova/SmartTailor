...
class Translations implements BaseTranslations<AppLocale, Translations> {
  ...
  String get repeatSendCode => 'Код введен неверно,\nпопробуйте еще раз';
...
extension on Translations {
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'sendPinCode':
        return 'Отправлен 4-х значный код\nна указанную почту';
      case 'repeatSendCode':
        return 'Код введен неверно,\nпопробуйте еще раз';
      case 'repeatSendCodeTime':
        return 'Отправить код повторно через';
      case 'repeatSendCodeButton':
      ...
      case 'SmartTailor':
        return 'SmartTailor';
      case 'enterText':
        return 'Мониторинг и управление\nшвейным производством';
      case 'emailHintText':
      ...
      case 'equipmentDetail':
        return 'Детали оборудования';
      case 'orderDetail':
        return 'Детали заказа';
      case 'author':
        return 'Автор объявления';
      case 'acceptOrder':
        return 'Откликнуться на заказ';
      case 'acceptService':
        return 'Откликнуться на услугу';
      case 'buy':
        return 'Купить';
      case 'order':
        return 'Заказ';
      ...
      case 'nitki':
        return 'Нитки';
      case 'equipmentDesk':
        return 'Описание инвентаря';
      case 'needIronman':
        return 'Требуется утюжник';
      case 'serviceDesc':
        return 'Мужские брюки';
      case 'typeOrder':
        return 'Тип объявления*';
      case 'typeOrderHint':
        return 'Оборудование,Заказ или Услуги';
      case 'nameOrder':
        return 'Название*';
      case 'necessaryField':
      ...
      case 'max5photos':
        return 'Максимальное количество фото 5';
      case 'sizeFieldText':
        return 'Только для типа объявления Заказ';
      case 'maxWords':
        return 'Максимум 1000 слов';
      case 'sizes':
        return 'Размеры*';
      case 'ddmmyy':
        return 'ДД/ММ/ГГ';
      case 'lastDate':
        return 'Крайняя дата выполнения';
      case 'contactInfo':
