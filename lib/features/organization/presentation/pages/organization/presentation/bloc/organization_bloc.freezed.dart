...
abstract class $OrganizationStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({StateStatus stateStatus, OrganizationInfoEntity organizationInfo});
...
class _$OrganizationStateImpl implements _OrganizationState {
  const _$OrganizationStateImpl(
      {required this.stateStatus, required this.organizationInfo});
  ...
  @override
  String toString() {
    return 'OrganizationState(stateStatus: $stateStatus, organizationInfo: $organizationInfo)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, stateStatus, organizationInfo);
