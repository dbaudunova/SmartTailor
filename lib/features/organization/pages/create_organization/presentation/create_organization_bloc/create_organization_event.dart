...
class CreateOrganizationEvent with _$CreateOrganizationEvent {
  ...
  const factory CreateOrganizationEvent.createOrganization(
      {required CreateOrganizationModel createModel}) = _CreateOrganization;
  const factory CreateOrganizationEvent.addImage({required File image}) =
      _AddImage;
