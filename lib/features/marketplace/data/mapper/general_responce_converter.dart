...
class GeneralResponceMapper extends Converter<GeneralResponceModel, GeneralResponceEntity> {
  @override
  GeneralResponceEntity convert(GeneralResponceModel input) {
    return GeneralResponceEntity(
        listEntitys:
            (input.listModels).map((e) => getIt<Converter<GeneralOrderModel, GeneralEntity>>().convert(e)).toList(),
        isLast: input.isLast,
