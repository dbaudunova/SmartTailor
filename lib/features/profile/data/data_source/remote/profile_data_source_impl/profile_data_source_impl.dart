...
class ProfileDataSourceImpl implements ProfileDataSource {
  ...
  @override
  Future<AnnouncementResponseModel> getMyEquipments(
  ...
  @override
  Future<AnnouncementResponseModel> getMyOrders(
      {required int pageNumber}) async {
    try {
      final response = await _client.get(
  ...
  @override
  Future<AnnouncementResponseModel> getMyServices(
      {required int pageNumber}) async {
    try {
      final response = await _client.get(
  ...
  @override
  Future<EquipmentDetailedModel> getEquipmentDetailedById(
