class HttpPaths {
  ...
  static const resendConfirmationCode =
      '$baseUrl/api/auth/resend-confirmation-code';
  ...
  static const getEquipmentById =
      '$baseUrl/api/equipment/get-equipment-detailed/';
  ...
  static const postRequestToExecute =
      '$baseUrl/api/order/send-request-to-execute-order/';
  ...
  static const sendSubscription =
      '$baseUrl/api/app-user/send-subscription-request';

  static const getOrganization = '$baseUrl/api/organization';
  static const createOrganization =
      '$baseUrl/api/organization/create-organization';
}
