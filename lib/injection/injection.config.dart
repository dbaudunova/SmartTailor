...
import 'package:neobis_smart_tailor/features/registration/presentation/bloc/registration_bloc.dart'
    as _i117;
import 'package:neobis_smart_tailor/injection/injection_module.dart' as _i142;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.singleton<_i114.PositionsBloc>(() => _i114.PositionsBloc(
          gh<_i103.AddPositionUseCase>(),
          gh<_i104.GetAllPositionsUseCase>(),
        ));
    gh.factory<_i115.InviteEmployeeRepo>(() =>
        _i116.InviteEmployeeRepoImpl(gh<_i97.InviteEmployeeDataSource>()));
    gh.factory<_i117.RegistrationBloc>(() => _i117.RegistrationBloc(
        registrationUseCase: gh<_i91.RegistrationUseCase>()));
    gh.singleton<_i118.ConfirmationUseCase>(
        () => _i118.ConfirmationUseCase(repo: gh<_i99.ConfirmationRepo>()));
    gh.singleton<_i119.ResendPinUseCase>(
        () => _i119.ResendPinUseCase(repo: gh<_i99.ConfirmationRepo>()));
    gh.singleton<_i120.CreateOrganizationUseCase>(() =>
        _i120.CreateOrganizationUseCase(
            repo: gh<_i76.CreateOrganizationRepo>()));
    gh.singleton<_i121.MarketplaceBloc>(() => _i121.MarketplaceBloc(
          gh<_i106.GetEuipmentsUseCase>(),
          gh<_i107.GetOrdersUseCase>(),
          gh<_i108.GetServicesUseCase>(),
        ));
    gh.singleton<_i122.CreateEquipmentUseCase>(
        () => _i122.CreateEquipmentUseCase(repo: gh<_i78.OrderPlaceRepo>()));
    gh.singleton<_i123.CreateOrderUseCase>(
        () => _i123.CreateOrderUseCase(repo: gh<_i78.OrderPlaceRepo>()));
    gh.singleton<_i124.CreateServiceUseCase>(
        () => _i124.CreateServiceUseCase(repo: gh<_i78.OrderPlaceRepo>()));
    ...
    gh.singleton<_i127.OrderPlaceBloc>(() => _i127.OrderPlaceBloc(
          gh<_i122.CreateEquipmentUseCase>(),
          gh<_i124.CreateServiceUseCase>(),
          gh<_i123.CreateOrderUseCase>(),
        ));
    gh.factory<_i128.ServiceDetailRepo>(() => _i129.ServiceDetailRepoImpl(
          gh<_i80.ServiceDetailDataSource>(),
          gh<_i8.Converter<_i9.ServiceDetailModel, _i10.ServiceDetailEntity>>(),
        ));
    gh.singleton<_i130.BuyEquipmentIdUseCase>(() =>
        _i130.BuyEquipmentIdUseCase(repo: gh<_i93.EquipmentDetailRepo>()));
    gh.singleton<_i131.GetEuipmentByIdUseCase>(() =>
        _i131.GetEuipmentByIdUseCase(repo: gh<_i93.EquipmentDetailRepo>()));
    gh.singleton<_i132.InviteEmployeeUseCase>(() =>
        _i132.InviteEmployeeUseCase(repo: gh<_i115.InviteEmployeeRepo>()));
    gh.singleton<_i133.ConfirmationBloc>(() => _i133.ConfirmationBloc(
          gh<_i118.ConfirmationUseCase>(),
          gh<_i119.ResendPinUseCase>(),
        ));
    ...
    gh.singleton<_i135.CreateOrganizationBloc>(() =>
        _i135.CreateOrganizationBloc(gh<_i120.CreateOrganizationUseCase>()));
    gh.singleton<_i136.InviteEmployeeBloc>(
        () => _i136.InviteEmployeeBloc(gh<_i132.InviteEmployeeUseCase>()));
    gh.singleton<_i137.GetAllEmployeesUseCase>(
        () => _i137.GetAllEmployeesUseCase(repo: gh<_i125.EmployeeRepo>()));
    gh.singleton<_i138.GetServiceByIdUseCase>(
        () => _i138.GetServiceByIdUseCase(repo: gh<_i128.ServiceDetailRepo>()));
    gh.singleton<_i139.EquipmentDetailBloc>(() => _i139.EquipmentDetailBloc(
          gh<_i131.GetEuipmentByIdUseCase>(),
          gh<_i130.BuyEquipmentIdUseCase>(),
        ));
    gh.singleton<_i140.EmployeeBloc>(
        () => _i140.EmployeeBloc(gh<_i137.GetAllEmployeesUseCase>()));
    gh.singleton<_i141.ServiceDetailBloc>(
        () => _i141.ServiceDetailBloc(gh<_i138.GetServiceByIdUseCase>()));
    return this;
  }
}
