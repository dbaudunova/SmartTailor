...
import 'package:neobis_smart_tailor/features/registration/presentation/bloc/registration_bloc.dart'
    as _i53;
import 'package:neobis_smart_tailor/injection/injection_module.dart' as _i62;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.singleton<_i52.SignOutUseCase>(
        () => _i52.SignOutUseCase(repo: gh<_i38.ProfileRepo>()));
    gh.factory<_i53.RegistrationBloc>(() => _i53.RegistrationBloc(
        registrationUseCase: gh<_i48.RegistrationUseCase>()));
    gh.singleton<_i54.ConfirmationUseCase>(
        () => _i54.ConfirmationUseCase(repo: gh<_i49.ConfirmationRepo>()));
    gh.singleton<_i55.ResendPinUseCase>(
        () => _i55.ResendPinUseCase(repo: gh<_i49.ConfirmationRepo>()));
    gh.singleton<_i56.CreateEquipmentUseCase>(
        () => _i56.CreateEquipmentUseCase(repo: gh<_i44.OrderPlaceRepo>()));
    gh.singleton<_i57.CreateOrderUseCase>(
        () => _i57.CreateOrderUseCase(repo: gh<_i44.OrderPlaceRepo>()));
    gh.singleton<_i58.CreateServiceUseCase>(
        () => _i58.CreateServiceUseCase(repo: gh<_i44.OrderPlaceRepo>()));
    gh.singleton<_i59.OrderPlaceBloc>(() => _i59.OrderPlaceBloc(
          gh<_i56.CreateEquipmentUseCase>(),
          gh<_i58.CreateServiceUseCase>(),
          gh<_i57.CreateOrderUseCase>(),
        ));
    gh.factory<_i60.ProfileBloc>(
        () => _i60.ProfileBloc(signOutUseCase: gh<_i52.SignOutUseCase>()));
    gh.singleton<_i61.ConfirmationBloc>(() => _i61.ConfirmationBloc(
          gh<_i54.ConfirmationUseCase>(),
          gh<_i55.ResendPinUseCase>(),
        ));
    return this;
  }
}
