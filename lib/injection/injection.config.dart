...
import 'package:neobis_smart_tailor/features/registration/presentation/bloc/registration_bloc.dart'
    as _i142;
import 'package:neobis_smart_tailor/injection/injection_module.dart' as _i170;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i127.GetEquipmentDetailedByIdUseCase>(() =>
        _i127.GetEquipmentDetailedByIdUseCase(repo: gh<_i108.ProfileRepo>()));
    gh.singleton<_i128.GetMyEquipmentsUseCase>(
        () => _i128.GetMyEquipmentsUseCase(repo: gh<_i108.ProfileRepo>()));
    gh.singleton<_i129.GetMyOrdersUseCase>(
        () => _i129.GetMyOrdersUseCase(repo: gh<_i108.ProfileRepo>()));
    gh.singleton<_i130.GetMyServicesUseCase>(
        () => _i130.GetMyServicesUseCase(repo: gh<_i108.ProfileRepo>()));
    gh.singleton<_i131.GetOrderDetailedByIdUseCase>(
        () => _i131.GetOrderDetailedByIdUseCase(repo: gh<_i108.ProfileRepo>()));
    gh.singleton<_i132.GetOrderHistoryForUserUseCase>(() =>
        _i132.GetOrderHistoryForUserUseCase(repo: gh<_i108.ProfileRepo>()));
    gh.singleton<_i133.GetProfileInfoUseCase>(
        () => _i133.GetProfileInfoUseCase(repo: gh<_i108.ProfileRepo>()));
    gh.singleton<_i134.GetServiceDetailedByIdUseCase>(() =>
        _i134.GetServiceDetailedByIdUseCase(repo: gh<_i108.ProfileRepo>()));
    gh.singleton<_i135.LoadMorePurchasesUseCase>(
        () => _i135.LoadMorePurchasesUseCase(repo: gh<_i108.ProfileRepo>()));
    gh.singleton<_i136.SendSubscriptionUseCase>(
        () => _i136.SendSubscriptionUseCase(repo: gh<_i108.ProfileRepo>()));
    gh.singleton<_i137.SignOutUseCase>(
        () => _i137.SignOutUseCase(repo: gh<_i108.ProfileRepo>()));
    gh.singleton<_i138.UploadImageUseCase>(
        () => _i138.UploadImageUseCase(repo: gh<_i108.ProfileRepo>()));
    gh.singleton<_i139.PositionsBloc>(() => _i139.PositionsBloc(
          gh<_i117.AddPositionUseCase>(),
          gh<_i118.GetAllPositionsUseCase>(),
        ));
    gh.factory<_i140.InviteEmployeeRepo>(() =>
        _i141.InviteEmployeeRepoImpl(gh<_i106.InviteEmployeeDataSource>()));
    gh.factory<_i142.RegistrationBloc>(() => _i142.RegistrationBloc(
        registrationUseCase: gh<_i102.RegistrationUseCase>()));
    gh.singleton<_i143.ConfirmationUseCase>(
        () => _i143.ConfirmationUseCase(repo: gh<_i110.ConfirmationRepo>()));
    gh.singleton<_i144.ResendPinUseCase>(
        () => _i144.ResendPinUseCase(repo: gh<_i110.ConfirmationRepo>()));
    gh.singleton<_i145.CreateOrganizationUseCase>(() =>
        _i145.CreateOrganizationUseCase(
            repo: gh<_i87.CreateOrganizationRepo>()));
    gh.singleton<_i146.MarketplaceBloc>(() => _i146.MarketplaceBloc(
          gh<_i122.GetEuipmentsUseCase>(),
          gh<_i123.GetOrdersUseCase>(),
          gh<_i124.GetServicesUseCase>(),
        ));
    gh.factory<_i147.ProfileBloc>(() => _i147.ProfileBloc(
          sendSubscriptionUseCase: gh<_i136.SendSubscriptionUseCase>(),
          signOutUseCase: gh<_i137.SignOutUseCase>(),
          getProfileInfoUseCase: gh<_i133.GetProfileInfoUseCase>(),
          editProfileInfoUseCase: gh<_i125.EditProfileInfoUseCase>(),
          uploadImageUseCase: gh<_i138.UploadImageUseCase>(),
          getMyOrdersUseCase: gh<_i129.GetMyOrdersUseCase>(),
          getMyEquipmentsUseCase: gh<_i128.GetMyEquipmentsUseCase>(),
          getMyServicesUseCase: gh<_i130.GetMyServicesUseCase>(),
        ));
    gh.singleton<_i148.CreateEquipmentUseCase>(
        () => _i148.CreateEquipmentUseCase(repo: gh<_i89.OrderPlaceRepo>()));
    gh.singleton<_i149.CreateOrderUseCase>(
        () => _i149.CreateOrderUseCase(repo: gh<_i89.OrderPlaceRepo>()));
    gh.singleton<_i150.CreateServiceUseCase>(
        () => _i150.CreateServiceUseCase(repo: gh<_i89.OrderPlaceRepo>()));
    gh.factory<_i151.OrderHistoryBloc>(() =>
        _i151.OrderHistoryBloc(gh<_i132.GetOrderHistoryForUserUseCase>()));
    gh.singleton<_i152.OrderPlaceBloc>(() => _i152.OrderPlaceBloc(
          gh<_i148.CreateEquipmentUseCase>(),
          gh<_i150.CreateServiceUseCase>(),
          gh<_i149.CreateOrderUseCase>(),
        ));
    gh.factory<_i153.ServiceDetailRepo>(() => _i154.ServiceDetailRepoImpl(
          gh<_i91.ServiceDetailDataSource>(),
          gh<
              _i9
              .Converter<_i10.ServiceDetailModel, _i11.ServiceDetailEntity>>(),
        ));
    gh.singleton<_i155.BuyEquipmentIdUseCase>(() =>
        _i155.BuyEquipmentIdUseCase(repo: gh<_i104.EquipmentDetailRepo>()));
    gh.singleton<_i156.GetEuipmentByIdUseCase>(() =>
        _i156.GetEuipmentByIdUseCase(repo: gh<_i104.EquipmentDetailRepo>()));
    gh.factory<_i157.PurchasesBloc>(() => _i157.PurchasesBloc(
          gh<_i126.GetAllPurchasesUseCase>(),
          gh<_i135.LoadMorePurchasesUseCase>(),
        ));
    gh.singleton<_i158.InviteEmployeeUseCase>(() =>
        _i158.InviteEmployeeUseCase(repo: gh<_i140.InviteEmployeeRepo>()));
    gh.factory<_i159.AnnouncementBloc>(() => _i159.AnnouncementBloc(
          gh<_i131.GetOrderDetailedByIdUseCase>(),
          gh<_i134.GetServiceDetailedByIdUseCase>(),
          gh<_i127.GetEquipmentDetailedByIdUseCase>(),
        ));
    gh.singleton<_i160.ConfirmationBloc>(() => _i160.ConfirmationBloc(
          gh<_i143.ConfirmationUseCase>(),
          gh<_i144.ResendPinUseCase>(),
        ));
    gh.singleton<_i161.ChangeOrderStatusUseCase>(() =>
        _i161.ChangeOrderStatusUseCase(repo: gh<_i115.CurrentOrdersRepo>()));
    gh.singleton<_i162.GetAllOrdersUseCase>(
        () => _i162.GetAllOrdersUseCase(repo: gh<_i115.CurrentOrdersRepo>()));
    gh.singleton<_i163.EmployeeBloc>(() => _i163.EmployeeBloc(
          gh<_i120.GetAllEmployeesUseCase>(),
          gh<_i121.GetEmployeeDetailUseCase>(),
        ));
    gh.factory<_i164.CreateOrganizationBloc>(() =>
        _i164.CreateOrganizationBloc(gh<_i145.CreateOrganizationUseCase>()));
    gh.singleton<_i165.CurrentOrderBloc>(
        () => _i165.CurrentOrderBloc(gh<_i162.GetAllOrdersUseCase>()));
    gh.singleton<_i166.InviteEmployeeBloc>(
        () => _i166.InviteEmployeeBloc(gh<_i158.InviteEmployeeUseCase>()));
    gh.singleton<_i167.GetServiceByIdUseCase>(
        () => _i167.GetServiceByIdUseCase(repo: gh<_i153.ServiceDetailRepo>()));
    gh.factory<_i168.EquipmentDetailBloc>(() => _i168.EquipmentDetailBloc(
          gh<_i156.GetEuipmentByIdUseCase>(),
          gh<_i155.BuyEquipmentIdUseCase>(),
        ));
    gh.factory<_i169.ServiceDetailBloc>(
        () => _i169.ServiceDetailBloc(gh<_i167.GetServiceByIdUseCase>()));
    return this;
  }
}
